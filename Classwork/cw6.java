...
/** Dorm and Meal Plan Calculator Mar 10
 * Create an application with two combo boxes.
 * One should hold the names of the dormitories, and the other should hold the meal plans.
 * The user should select a dormitory and a meal plan, and the application should show the total charges for the semester.
 */

public class cw6 extends JFrame
{
